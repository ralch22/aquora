// "Frequently bought together" is driven by an honest complementary-category map
// (top category handle -> related top category handles), NOT fabricated order data.
// Handles match the Medusa top-category handles (see lib/aquora/categories.ts).
