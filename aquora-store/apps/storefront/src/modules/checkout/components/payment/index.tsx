    ...
    <div className="bg-white">
      <div className="flex flex-row items-center justify-between mb-6">
        ...
        {!isOpen && paymentReady && (
          <Text>
            <button
              onClick={handleEdit}
              className="text-aquora-primary hover:text-aquora-primary-hover"
      ...
      <div>
        <div className={isOpen ? "block" : "hidden"}>
          ...
          {isOpen && !paidByGiftcard && <ExpressCheckout cart={cart} />}
          ...
          {paidByGiftcard && (
            <div className="flex flex-col w-1/3">
              ...
              <Text
                className="txt-medium text-aquora-muted"
          ...
          {cart && paymentReady && activeSession ? (
            <div className="flex items-start gap-x-1 w-full">
              ...
              <div className="flex flex-col w-1/3">
                ...
                <div
                  className="flex gap-2 txt-medium text-aquora-muted items-center"
